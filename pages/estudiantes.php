...
<body>
    ...
    <div id="wrapper">
                    ...
                    <ul class="dropdown-menu dropdown-messages">
                        ...
                        <li>
                            <a class="text-center" href="#">
                                <strong>Read All Me ssages</strong>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Lista de Estudiantes Danger</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
...
<?php 
                ...
                while($row = $resultado->fetch_assoc()) 
                    ...
                    <td>
                        <div class="tooltip-demo">
                            <button type="button" class="btn btn-xs btn-primary" data-toggle="tooltip" data-placement="bottom" title="Editar"><i class="ace-icon fa fa-pencil bigger-120"></i>Editar</button> 
    ...
    ?>
				...
				<div class="modal-content">
					...
					<div class="modal-body" id="formulariomodal">
						<div class="row">
							...
							<div class="form-group col-md-6">
								<label for="paterno" class="col-sm-5 control-label">Apellido Paterno</label>
								<div class="col-sm-7">
									<input id="paterno" name="paterno" class="form-control" >
								</div>
							</div>
                            <div class="form-group col-md-6">
                                <label for="materno" class="col-sm-5 control-label">Apellido Materno</label>
                                <div class="col-sm-7">
							...
							<div class="form-group col-md-6">
                                ...
                                <div class="col-md-6">
                                      <div class="input-group date datepicker" id="calendario">
                                        <input type="text" class="form-control" id="" name="fechaNacimiento">
        ...
        <div class="modal fade" id="modalBorrarLista" tabindex="-1" role="dialog" aria-labelledby="modalBorrarLista" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header bg-primary">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                        <h4 class="modal-borrar" id="modalBorrarLista">Lista de Estudiantes a borrar</h4>
                    </div>
                    <div class="modal-bod" >
                        <div id="borrar"> </div>
                    </div>
    ...
    <script src="../vendor/bootstrap/js/bootstrap.min.js" rel="stylesheet"></script>

    <!-- Metis Menu Plugin JavaScript -->
    <script src="../vendor/metisMenu/metisMenu.min.js" rel="stylesheet"></script>
    ...
    <script>
        ...
        //funcoion para agregar datos de formulario modal a la base de datos y mostrarlos
   ...
   $('#insert_form').on("submit", function(event){
     ...
     $(document).ready(function() {
        ...
        //funcion para mostrar busqueda y cantidad por vista c
    $(document).ready(function() {
...
/*   function borrarseleccionado(object) {
      ...
      for(var i=0, n=checkboxes.length;i<n;i++) {
        ...
        if(checkboxes[i].checked)
            checkboxes.removeChild(checkboxes[i].parentNode.parentNode);
	...
	function recorrerLista() {
		$(document).ready(function() {
			...
			$("#dataTables-estudiantes tbody tr").each(function (i, item) {
                ...
                var genero = $(item).children().get(4);
				str += '<p>Nro:' + $(numero).text() + ' DNI:' + $(dni).text() + ' Nombres:' + $(nombres).text() +  ' genero:' + $(genero).text() + '</p>';
			});
			$("#lista").html(str);
		});
	}
